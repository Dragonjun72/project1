...
/*
	...
	cout << "총 메모리량 : " << sizeof(arr) << endl;
	cout << " 가로 행의 메모리량 : " << sizeof(arr[0]) << endl; //배열의 첫번째 행 전체 
	cout << " 가로 세로 1칸의 메모리 량 : " << sizeof(arr[0][0]) << endl;
	cout << " 열의 길이 : " << arr_col_len << endl;
	cout << " 행의 길이 : " << arr_row_len << endl;
...
/*	int num1 = 1234;
	...
	cout << "포인터 ptr_num1가 가르키고 있는 주소값은 " << ptr_num1 << "입니다." << endl;
	cout << "포인터 ptr_num1가 가르키고 있는 주소에 저장된 값은 " << *ptr_num1 << "입니다." << endl;
	cout << "포인터 ptr_num2가 가르키고 있는 주소값은 " << ptr_num2 << "입니다." << endl;
	cout << "포인터 ptr_num2가 가르키고 있는 주소에 저장된 값은 " << *ptr_num2 << "입니다.";
*/
